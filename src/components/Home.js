...
export default function Home() {
    ...
    return (
        <section id="Home" className=" relative overflow-hidden pb-14 xl:pb-0 flex justify-center items-center">
            ...
            <div className="star_animation top-[12%] left-[13%] md:top-[30%] md:left-[35%] w-[8px] h-[8px] bg-[#f67f03] stars"></div>
            ...
            <div className='container flex flex-col lg:flex-row justify-center items-center h-screen mt-[35%] md2:mt-[25%] lg:mt-0 md:pt-[8vh] lg:w-[90%]  relative text-center lg:text-start'>
                <div className='flex-1 '>
                    ...
                    <Link className=' relative z-[1] text-[1.1rem] py-[5px] px-[25px] rounded-[5px] transition_3 inline-block hover:scale-110 bg-gradient-to-r from-[#4937f0] to-[#9244f0]'
                        to='https://www.dropbox.com/scl/fi/rbe8jej40493uuqkfayrk/CV.pdf?rlkey=duvz3gs9z2ic2c2xswqmu7xzx&dl=0' target='black'
                    >Download CV</Link>

                </div>
                <div className='flex  flex-1 justify-center'>
                    <div loading='lazy' className='mainPhoto relative w-[340px] h-[340px] ssm:w-[380px] ssm:h-[380px] sm:w-[430px] sm:h-[430px] rounded-[50%]'>
                        {/* Icons */}
                        <img loading='lazy' className='one w-[135px] top-[15px] left-[-16px] homeImages hidden sm:block' src={brushPen} alt='' />
                        <img loading='lazy' className='two w-[145px] bottom-[-20px] left-[30px] homeImages hidden sm:block' src={penTool} alt='' />
                        <img loading='lazy' className='three w-[145px] top-[135px] right-[-60px] homeImages hidden sm:block' src={webDesign} alt='' /></div>
                </div>
            </div>
            {/* Wave Effect */}
            <div className="ocean">
