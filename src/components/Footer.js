...
export default function Footer() {
    ...
    return (
        <footer className="bg-[#211141] overflow-hidden relative min-h-[35vh] flex flex-col justify-center items-center">
            <div className="container w-[90%] lg:w-[80%] h-[90%] py-[15px] pl-0 pr-[35px] flex justify-between items-center flex-wrap flex-col md:flex-row mb-20 md2:mb-0">
                <div className="">
                    <h1 className="text-[1.7rem] sm:text-[1.9rem] md:text-[2.3rem] text-center md:text-start">DON'T BE SHY !</h1>
                    <p className="text-[0.8rem] text-center mt-[-10px] md:text-start md:mt-0 md:text-[1rem] leading-4 lg:leading-5 font-light opacity-70">
                ...
                <img src={`${logo}`} alt='' className="text-center mt-[35px] mx-[30px] mb-[20px]  sm:mt-[45px] sm:mx-[30px] sm:mb-[30px] md:my-0 md:mx-[30px] w-[140px] sm:w-[140px] lg:w-[180px]" />
                <div className="">
                    <h1 className="text-[1.7rem] sm:text-[1.9rem] md:text-[2.3rem] text-center md:text-end md:text-start">Who am i ?</h1>
                    <p className="text-[0.8rem] text-center mt-[-10px] md:text-end md:mt-0 md:text-[1rem] leading-4 lg:leading-5 font-light opacity-70">
